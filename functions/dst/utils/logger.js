...
export const unsafeStdout = BooleanEnvVarSchema.parse(process.env.MONEYMAN_UNSAFE_STDOUT);
 ...
 * @unsafe
 */
export function logToPublicLog(message, logger = createLogger("logToPublicLog")) {
    if (!unsafeStdout) {
