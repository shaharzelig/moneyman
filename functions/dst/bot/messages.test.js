...
import { createSaveStats, statsString, getSkippedCount, skippedString, } from "./saveStats.js";
...
describe("messages", () => {
    describe("getSummaryMessages", () => {
        it("should return a summary message", () => {
            ...
            const stats = [
                createSaveStats("Storage 1", "TheTable", txns1, {
                    added: txns1.length,
                }),
                createSaveStats("Storage 2", "TheTable", txns2, {
                    added: txns2.length,
        ...
        it("should return a summary message with installments", () => {
            ...
            const stats = [
                createSaveStats("Storage 1", "TheTable", transactions, {
                    added: 2,
                    highlightedTransactions: {
    ...
    describe("skippedString", () => {
        ...
        it("should format all three types of skipped transactions", () => {
            ...
            expect(skippedString(stats)).toBe("4 skipped (1 existing, 1 pending, 2 other)");
        });
        it("should format with multiple of each type", () => {
            ...
            expect(skippedString(stats)).toBe("15 skipped (5 existing, 3 pending, 7 other)");
        });
    });
