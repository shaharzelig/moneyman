...
jest.mock("telegraf", () => ({ Telegraf: mock() }));
describe("config", () => {
    let originalEnv;
    beforeEach(() => {
    ...
    it.each(internalUrls)("should support internal URL %s for actual.serverUrl", async (url) => {
        const configWithUrl = {
            accounts: [{ companyId: "test", password: "pass", userCode: "12345" }],
            storage: {
                actual: {
    ...
    it.each(internalUrls)("should support internal URL %s for webPost.url", async (url) => {
        const configWithUrl = {
            accounts: [{ companyId: "test", password: "pass", userCode: "12345" }],
            storage: {
                webPost: {
    ...
    describe("getIpInfoUrl configuration", () => {
        ...
        it("should allow getIpInfoUrl to be a valid URL string", () => {
            ...
            expect(parsed.options.logging.getIpInfoUrl).toBe("https://api.myservice.com/ip");
        });
